...
@pytest.mark.parametrize(
    "matching_includes, expected_filename",
    [
        (r'/include "C:\DATA\ECU.A2L"', r"C:\DATA\ECU.A2L"),
        (r'/INCLUDE "..\includes\CANAPE_OET.A2L"', r"..\includes\CANAPE_OET.A2L"),
        (
            r'/INCLUDE "\\server1\documents\templates\template.aml"',
            r"\\server1\documents\templates\template.aml",
        ),
        ...
        (
            r'/begin A2ML /include "/home/user/IF_DATA/XCP.txt" STV_N /* name */ /end A2ML',
            r"/home/user/IF_DATA/XCP.txt",
        ),
        (
            r'/begin MODULE /Include My_Module.A2L UNIT 2 "" "" DERIVED /end MODULE',
            r"My_Module.A2L",
        ),
        (
            r'/begin PROJECT /include "\\Z:\tmp\ecu project.a2l" /* EOF */ /end PROJECT',
            r"\\Z:\tmp\ecu project.a2l",
        ),
        (
            (
                r'/begin PROJECT /include "/home/ecu/header/my_header.a2l" '
                r"/include my_module.a2l /end PROJECT"
            ),
