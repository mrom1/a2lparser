...
def test_rules_record_layout():
    ...
    assert record_layout["FIX_NO_AXIS_PTS_Z4"] == "17"
    assert record_layout["FIX_NO_AXIS_PTS_Z5"] == "17"
    ...
    assert record_layout["AXIS_PTS_Z4"]["Position"] == "3"
    assert record_layout["AXIS_PTS_Z4"]["Datatype"] == "ULONG"
    assert record_layout["AXIS_PTS_Z4"]["IndexIncr"] == "INDEX_INCR"
    assert record_layout["AXIS_PTS_Z4"]["Addressing"] == "DIRECT"

    assert record_layout["AXIS_PTS_Z5"]["Position"] == "3"
    assert record_layout["AXIS_PTS_Z5"]["Datatype"] == "ULONG"
    assert record_layout["AXIS_PTS_Z5"]["IndexIncr"] == "INDEX_INCR"
    assert record_layout["AXIS_PTS_Z5"]["Addressing"] == "DIRECT"
    ...
    assert record_layout["DIST_OP_Z4"]["Position"] == "21"
    assert record_layout["DIST_OP_Z4"]["Datatype"] == "UWORD"

    assert record_layout["DIST_OP_Z5"]["Position"] == "21"
    assert record_layout["DIST_OP_Z5"]["Datatype"] == "UWORD"
    ...
    assert record_layout["NO_AXIS_PTS_Z4"]["Position"] == "2"
    assert record_layout["NO_AXIS_PTS_Z4"]["Datatype"] == "UWORD"

    assert record_layout["NO_AXIS_PTS_Z5"]["Position"] == "2"
    assert record_layout["NO_AXIS_PTS_Z5"]["Datatype"] == "UWORD"
    ...
    assert record_layout["OFFSET_Z4"]["Position"] == "16"
    assert record_layout["OFFSET_Z4"]["Datatype"] == "UWORD"

    assert record_layout["OFFSET_Z5"]["Position"] == "16"
    assert record_layout["OFFSET_Z5"]["Datatype"] == "UWORD"
    ...
    assert record_layout["RIP_ADDR_Z4"]["Position"] == "19"
    assert record_layout["RIP_ADDR_Z4"]["Datatype"] == "UWORD"

    assert record_layout["RIP_ADDR_Z5"]["Position"] == "19"
    assert record_layout["RIP_ADDR_Z5"]["Datatype"] == "UWORD"
    ...
    assert record_layout["SRC_ADDR_Z4"]["Position"] == "1"
    assert record_layout["SRC_ADDR_Z4"]["Datatype"] == "UWORD"

    assert record_layout["SRC_ADDR_Z5"]["Position"] == "1"
    assert record_layout["SRC_ADDR_Z5"]["Datatype"] == "UWORD"
    ...
    assert record_layout["SHIFT_OP_Z4"]["Position"] == "21"
    assert record_layout["SHIFT_OP_Z4"]["Datatype"] == "UWORD"

    assert record_layout["SHIFT_OP_Z5"]["Position"] == "21"
    assert record_layout["SHIFT_OP_Z5"]["Datatype"] == "UWORD"
